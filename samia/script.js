document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculateTopFunnel() {
        ...
        const impressions = cpm > 0 ? (valorUsado * 1000) / cpm : 0;
    ...
    function calculateMidFunnel() {
        ...
        const paymentInfoConversionRate = initiatedCheckouts > 0 ? (paymentInfos / initiatedCheckouts) * 100 : 0;
    ...
    function calculateBottomFunnel() {
        ...
        const conversionRatePurchase = paymentInfos > 0 ? (purchases / paymentInfos) * 100 : 0;
        ...
        const roi = valorUsado > 0 ? (revenue - valorUsado) / valorUsado : 0;
